<div class="container">
    ...
    <div class="card">
        ...
        <input type="text" name="nama" class="form-control" id="nama" value="<?= $kegiatan['nama']; ?>">
        <small class="form-text text-danger"><?= form_error('nama'); ?></small>
        </div>
        <div class="form-group">
        <label for="text">Tanggal Awal</label>
        <input type="date" name="tgl_awal" class="form-control" id="tgl_awal" value="<?= $kegiatan['tanggal_awal']; ?>">
        <small class="form-text text-danger"><?= form_error('tgl_awal'); ?></small>
        </div>
        <div class="form-group">
        <label for="text">Tanggal Akhir</label>
        <input type="date" name="tgl_akhir" class="form-control" id="tgl_akhir" value="<?= $kegiatan['tanggal_akhir']; ?>">
        <small class="form-text text-danger"><?= form_error('tgl_akhir'); ?></small>
        <div class="form-group">
        <label for="text">Alamat</label>
        <input type="text" name="alamat" class="form-control" id="alamat" value="<?= $kegiatan['alamat']; ?>"> 
        <small class="form-text text-danger"><?= form_error('alamat'); ?></small>
        <div class="form-group">
        <label for="file">Upload Gambar</label>
        <input type="file" name="gambar" class="form-control" id="gambar" value="<?= $kegiatan['galeri']; ?>">
        </div>
